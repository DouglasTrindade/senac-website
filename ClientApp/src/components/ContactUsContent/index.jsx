      ...
      <div className="d-flex flex-column align-items-center mt-5">
        ...
        <div className="mt-5 rounded" style={{width: '520px', height: '470px', backgroundColor: '#FAFAFA'}}>
          <div className="container d-flex flex-column py-5 px-5">
            <label htmlFor="" className="form-label mt-2" style={{color: '#004A8C'}}>Nome<input type="text" className="form-control mt-2" /></label>
            <label htmlFor="" className="form-label mt-2" style={{color: '#004A8C'}}>E-mail<input type="text" className="form-control mt-2" placeholder="nome@exemplo.com"/></label>
            <label for="" className="form-label mt-2" style={{color: '#004A8C'}}>Mensagem
